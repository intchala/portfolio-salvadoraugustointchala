/**
 * adicionar add event listener em multiplos elementos
 */
...
/**
 * header
 * ativação de header quando window scroll p 100px
 */
...
const initSlider = function (currentSlider) {
  ...
  const sliderNetxBtn = currentSlider.querySelector("[data-slider-next]");
  ...
  sliderNetxBtn.addEventListener("click", slideNext);
  ...
  if (dontHaveExtraItem) {
    sliderNetxBtn.style.display = "none";
    sliderPrevBtn.style.display = "none";
  }

  /**
   * slide com shift+mouse wheel
   */
